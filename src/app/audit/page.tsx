          ...
          <Card className="h-fit">
            ...
            <CardContent className="space-y-3 text-sm">
              <div className="flex items-center justify-between">
                ...
                <span className={step === "location" ? "font-semibold" : "text-muted-foreground"}>
                  {step === "location" ? "Active" : ""}
                </span>
              </div>
              <div className="flex items-center justify-between">
                <span>2. Tools & spend</span>
                <span className={step === "tools" ? "font-semibold" : "text-muted-foreground"}>
                  {step === "tools" ? "Active" : ""}
                </span>
              </div>
              <div className="flex items-center justify-between">
            ...
            <div className="space-y-6">
                ...
                <CardContent className="space-y-4">
                  <div className="grid gap-4 md:grid-cols-3">
                    {report.totalsByCurrency.map((totals) => (
                      <div key={totals.currency} className="rounded-md border p-4">
                        <p className="text-xs uppercase tracking-[0.2em] text-muted-foreground">
                          {totals.currency}
                        </p>
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  {report.results.map((result) => (
                    <div key={result.toolId} className="rounded-md border p-4">
              ...
              {report.totalsByCurrency[0] &&
                report.totalsByCurrency[0].savingsMonthly >= 500 && (
                  <Card>
                    <CardHeader>
                      <CardTitle>Credex can help</CardTitle>
                      <CardDescription>
